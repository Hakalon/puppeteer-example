    ...
    while (1) {
      switch (_context8.prev = _context8.next) {
        case 0:
                ...
                while (1) {
                  switch (_context5.prev = _context5.next) {
                    ...
                    case 7:
                      ...
                      _context5.next = 10;
                      return recognize(newPath).then(function (res) {
          ...
          if (!existsSync('./checkimg')) {
            mkdirSync('./checkimg');
          }

          if (!existsSync('./init.json')) {
            _context8.next = 16;
            break;
          }

          init = JSON.parse(readFileSync('./init.json').toString());
          _context8.next = 18;
          break;
                ...
                switch (_context.prev = _context.next) {
                  case 0:
                    ...
                    if (res <= 2509200000 + init.earlyMin * 60 * 1000) {
                      ...
                      padTitle('Alert', "Wait for ".concat(((res - (2509200000 + init.earlyMin * 60 * 1000)) / 1000 / 60 / 60).toFixed(1), " hours to trigger booking event"));
                    }
