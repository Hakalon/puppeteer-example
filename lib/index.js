...
regeneratorRuntime.mark(function _callee8() {
  var padTitle, convertYear, getPropertyValue, _getPropertyValue, checkImg, _checkImg, getImg, _getImg, book, _book, browser, timePage;
                ...
                while (1) {
                  switch (_context7.prev = _context7.next) {
                    ...
                    case 14:
                      ...
                      padTitle('Restart', "The lastest date is ".concat(value, ", book date is ").concat(init.bookDate));
                      _context7.next = 20;
                      return draftPage.reload();
